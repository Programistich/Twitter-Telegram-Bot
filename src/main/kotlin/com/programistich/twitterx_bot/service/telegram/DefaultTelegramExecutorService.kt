...
import com.programistich.twitterx_bot.telegram.TelegramBotInstance
import com.programistich.twitterx_bot.service.translate.TranslateService
...
class DefaultTelegramExecutorService(
    private val telegramBot: TelegramBotInstance,
    ...
    override fun sendTweet(
        ...
        when (typeMessage) {
            ...
            is TypeMessageTelegram.ManyMediaMessage -> {
                ...
                telegramBot.execute(SendMessage(chatId, "Что-то пошло не так"))
            }
        }
    }
